    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-4">
          ...
          <button className="relative bg-white/10 backdrop-blur-md border border-white/20 text-gray-700 px-6 py-3 rounded-2xl font-bold text-sm tracking-wider uppercase transition-all duration-500 hover:bg-white/20 hover:border-white/30 hover:shadow-2xl hover:shadow-gray-500/25 transform hover:-translate-y-1 active:translate-y-0 group">
            <span className="relative z-10 flex items-center space-x-2">
